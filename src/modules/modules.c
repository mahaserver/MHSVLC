...
void __module_LoadBuiltins( vlc_object_t * p_this )
{
    ...
    AllocateBuiltinModule( p_this, vlc_entry__rc );
    	AllocateBuiltinModule( p_this, vlc_entry__access_file );
    	AllocateBuiltinModule( p_this, vlc_entry__mpga );
    	AllocateBuiltinModule( p_this, vlc_entry__mpeg_audio );
    	AllocateBuiltinModule( p_this, vlc_entry__id3tag );
    	AllocateBuiltinModule( p_this, vlc_entry__mpgatofixed32 );
    	AllocateBuiltinModule( p_this, vlc_entry__converter_fixed );
    	AllocateBuiltinModule( p_this, vlc_entry__converter_float );
    	AllocateBuiltinModule( p_this, vlc_entry__float32_mixer );
    	AllocateBuiltinModule( p_this, vlc_entry__spdif_mixer );
    	AllocateBuiltinModule( p_this, vlc_entry__trivial_mixer );
    	AllocateBuiltinModule( p_this, vlc_entry__mono );
    	AllocateBuiltinModule( p_this, vlc_entry__trivial_channel_mixer );
    	AllocateBuiltinModule( p_this, vlc_entry__simple_channel_mixer );
    	AllocateBuiltinModule( p_this, vlc_entry__headphone_channel_mixer );
    	AllocateBuiltinModule( p_this, vlc_entry__dolby_surround_decoder );
    	AllocateBuiltinModule( p_this, vlc_entry__bandlimited_resampler );
    	AllocateBuiltinModule( p_this, vlc_entry__ugly_resampler );
    	AllocateBuiltinModule( p_this, vlc_entry__linear_resampler );
    	AllocateBuiltinModule( p_this, vlc_entry__trivial_resampler );
    	AllocateBuiltinModule( p_this, vlc_entry__mhsopengl );
#ifndef NOCAPABILITY
    	AllocateBuiltinModule( p_this, vlc_entry__aout_sdl );
    #endif
}
