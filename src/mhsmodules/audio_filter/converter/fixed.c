#define MODULE_NAME converter_fixed
#define MODULE_PATH converter_fixed
#define MODULE_STRING "converter_fixed"
#define __BUILTIN__
/*****************************************************************************
...
test1=(p_filter->input.i_format==VLC_FOURCC('f','i','3','2'));
test2=(p_filter->output.i_format==AOUT_FMT_S16_NE);
